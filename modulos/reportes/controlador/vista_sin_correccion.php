            ...
            for ($j = 0; $j < count($regau); $j++) {
                ...
                if ($id_dias_b == 1) {//lunes a sabado
                    ...
                    if ($fecha_domingo !== "Sunday") {
                        $tra = new asistencia();
                        $reg = $tra->get_asistencia_seleccion_sin_dni($fecha_incremental, $id_usuario_b);
...
//                        $id = $reg[0]["id_asistencia"];
                        if (((int)count($reg))==0) {
                            ...
                            if ($get_estado == "v" || $get_estado == "m") {
                                ...
                                echo "<td>" . "----" . "</td>";
                                echo "<td>" . "----" . "</td>";
                                echo "<td><font color =red >Falto</font>".$_SESSION["todos_marcar"].count($reg)."</td>";
                                $cadena = "";
...
//                                                $_SESSION["todos_marcar"] = $_SESSION["todos_marcar"] + 1;
                                            ...
                                            echo "<td><font color =blue >Salida</font>".$_SESSION["todos_marcar"]."</td>";
                                        }
