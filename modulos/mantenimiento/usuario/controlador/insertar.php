...
$i_horario=$_POST["i_horario"];


$tra=new usuario(); 
$tra->add_usuario($i_perfil, $i_dni, $nombre, $i_apellidos, $i_sexo, $i_fecha_naci, $i_departamento, $i_telefono,
        $i_clave, $i_cargo, $i_sede, $i_ini_contrato, $i_fin_contrato, $id_usuario_sesion, $i_estado,$i_tipo_contrato,$i_horario);
?>