...
$m_id_horario=$_POST["m_id_horario"];

$tra=new horario(); 
$tra->update_horario($i_tipo_contrato, $i_dias, $hora_entrada_com, $hora_salida_com,
        $hora_entrada_com_re, $hora_salida_com_re, $i_estado, $id_usuario_sesion, $m_id_horario);
?>