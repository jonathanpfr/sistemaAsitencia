$(document).ready(function () {
    ...
    $('#btn_actualizar').click(function (e) {
        ...
        var m_id_sede = $("#m_id_sede").val();//i_estado
    ...
    $('#btn_eliminar').click(function (e) {
        ...
        var e_id_sede = $("#e_id_sede").val();
        var dataString = 'e_id_sede=' + e_id_sede;
...
{
    $.post("consultas/buscar_sede.php", {id_sede: id_dato}, function (data) {
        var dato = $.trim(data);
        $.each(JSON.parse(dato), function (idx, obj) {
            $("#m_id_sede").val(id_dato);
            $("#m_nombre").val(obj.nombre_sede);
